...
$(document).ready(function () {
  ...
  var img_length = $('.slide .one').length;
  var prev_img = img_length;
  var active_img = 1;
  var next_img = 2; // txt 

  var prev_2_txt = img_length;
  var prev_txt = 1;
  var active_txt = 2;
  ...
  var one_item_length = $('.infographics.base .slide .one-item').length;
  one_item_length = one_item_length % 2 === 0 ? one_item_length : one_item_length + 1;
  var slide_width = one_item_length / 2 * 50;
  $('.infographics.base .ss-content .slide').css("width", slide_width + "%");
  var slide_length = one_item_length / 2;
  var next_sl = 2;
  var prev_sl = 1;
  console.log();
  ...
  var item_length = $('.news .one-item').length;
  var item_row = parseInt(item_length / 2);
  ...
  for (var i = 0; i < item_row; i++) {
    ...
    $('.news .one-item:nth-child(' + (2 * i + 2) + ') .number-top-view').text((i + 1 + item_row).toString()); // $('.news .one-item:nth-child('+ (2 * i + 2) +') .number-top-view').text((i+1+item_row).toString());
  }
});